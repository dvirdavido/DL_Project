...
class AEC_Dataset(Dataset):
    ...
    def __init__(self,args,data_dir,batch_size,starting_point, amount):
        ...
        self.os_listdir = os.listdir(self.data_dir+'/farend_speech_aligned')
    ...
    def __getitem__(self,idx):
        ...
        target_wav  = self.data_dir+'/nearend_speech_scaled/nearend_speech_fileid_'+str(idx_)+'.wav'
        mic_wav = self.data_dir+'/nearend_mic_signal/nearend_mic_fileid_'+str(idx_)+'.wav'
        ref_wav = self.data_dir+'/farend_speech_aligned/farend_speech_fileid_'+str(idx_)+'.wav'
        echo_wav = self.data_dir+'/echo_signal/echo_fileid_'+str(idx_)+'.wav'

        return  self.audio_pre_process.transformations(mic_wav,ref_wav,target_wav,echo_wav)
